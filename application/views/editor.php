        ...
        <div class="col-md-12">
            <div class="box box-info" id="validate">
                ...
                <div class="box-body pad">
                    ...
                    <hr />
                    <label>正确答案</label>
                   <select class="form-control" id="textOne" value=<?php echo $answer?>>
                   ...
                   <select class="form-control" id="textTwo" value=<?php echo $answer?>>
                       <option value=''>请选择</option>
                        <option value=T>正确</option>
                        <option value=F>错误</option>
                    </select>
                    <input class="form-control" type="text" id="textThree" value=<?php echo $answer?>>
...
$(document).ready(function(){
	...
	$('#type').change(function(){
	   ...
	   $("button#submitquestion").on("click",function(){
           ...
           $.ajax({
               url:"<?php echo site_url('Question/update_question')?>",
               type: 'POST',
               data: {
